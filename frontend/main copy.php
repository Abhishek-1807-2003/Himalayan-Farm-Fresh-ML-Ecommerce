...
function closeHelloModal() {
    ...
    alert("Your order has been placed, you have chosen: " + selected + " as your payment mode"); // abhi bas alert dikhayega
    closeHelloModal(); // popup band hoga
}
...
<div id="helloModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white p-6 rounded-lg shadow-lg w-80 text-center">
    ...
    <button onclick="processPayment()" class="mt-5 px-4 py-2 bg-green-600 text-white rounded w-full">
      Pay Now
    </button>
  </div>
</div>
