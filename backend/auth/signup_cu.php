...
<body class="bg-cover bg-center bg-fixed bg-no-repeat" 
      style="background-image: url('https://images.pexels.com/photos/2219701/pexels-photo-2219701.jpeg?cs=srgb&dl=pexels-ianslater-2219701.jpg&fm=jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
<main class="min-h-screen flex items-center justify-center bg-black bg-opacity-50 p-4">
    <div class="bg-white p-8 md:p-12 rounded-2xl shadow-2xl w-full max-w-lg space-y-6">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-500 text-sm">Sign up as a customer</p>
        </div>

        <!-- Signup Form -->
        <form action="action/signup.php" method="POST" id="customerSignupForm" class="space-y-4" novalidate>
        ...
        <div class="text-center text-sm text-gray-500 mt-4">
            ...
            <a href="./login_cu.php" class="text-green-500 hover:underline font-semibold ml-1">Login</a>
        </div>
    </div>
</main>
