        ...
        <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white transition-colors duration-300">FAQs</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="text-sm">Address: Lethipora, Pampore, Jammu and Kashmir, India</p>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkoutButton.addEventListener('click', function() {
                if (cart.length > 0) {
                    ...
                    // In a real application, you would redirect to a checkout page or open a checkout modal here.
                } else {
